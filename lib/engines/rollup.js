    ...
    const config = {
      ...
      plugins: [
        ...
        babel({
          ...
          presets: [
            [
              resolve('@babel/preset-env', import.meta.url),
              {
            ...
            [
              resolve('@babel/preset-typescript', import.meta.url),
              {
                jsxPragma,
          ...
          plugins: [
            [
              resolve('@babel/plugin-transform-react-jsx', import.meta.url),
              {
            ...
            nomodule && [
              resolve('babel-plugin-transform-async-to-promises', import.meta.url),
              { inlineHelpers: true },
            ],
            resolve('babel-plugin-macros', import.meta.url),
          ].filter(Boolean),
        }),
        importMetaAssets(),
        {
