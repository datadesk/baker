...
function createStaticTag(cwd, pathPrefix, sources) {
...
function createStaticAbsoluteTag(cwd, domain, pathPrefix, sources) {
  // reuse our logic from createStaticTag
  const static = createStaticTag(cwd, pathPrefix, sources);
...
module.exports = { createStaticAbsoluteTag, createStaticTag };
